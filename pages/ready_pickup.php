...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3><b>Pickup</b> | <small>Outbound</small></h3>
        </div>
    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table bulk_action">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ((array)$db->viewPickuplist() as $x) {
                                            ?>
                                            <tr>
                                                <td><input type="checkbox" class="item_checkbox" value="<?php echo htmlspecialchars($x['item_code']); ?>" data-total-qty="<?php echo htmlspecialchars($x['qty']); ?>"></td>
                                                <td><?php echo $no++; ?></td>
                                                <td><?php echo htmlspecialchars($x['good_issue_number']?? ''); ?></td>
                                                <td><?php echo htmlspecialchars($x['order_number']?? ''); ?></td>
                                                ...
                                                <td><?php echo htmlspecialchars($x['department_name']?? ''); ?></td>
                                            </tr>
                                            <?php 
                                            }
                                            ?>
