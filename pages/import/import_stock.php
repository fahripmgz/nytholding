...
<div class="">
          ...
          <div class="page-title">
            <div class="title_left">
              <h3>
                     Import Consumable Stock  | 
                    <small>
                       Please import from Excel Document
                    </small>
                </h3>
            </div>
          ...
          <div class="row">
     		    <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="x_panel">
                <div class="x_title">
                  <h2><small>Export File Excel</small></h2>
				...
				<div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
					   ...
					   <h2>Info :</h2>
					  <button type="submit" class="btn btn-info ">Download Format </button>
