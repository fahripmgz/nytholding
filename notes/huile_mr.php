...
$sqlquery=mysql_query("select * from item_material_request_tmp a left join master_catalog b on a.item_code=b.item_code left join master_maesurement c on b.maesurement=c.id_mae where a.no_mr='$mr'");
